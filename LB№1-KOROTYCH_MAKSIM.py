...
# Автор: (Коротич Максим)

# Завдання 1: Створення змінних та введення чисел
...
# Завдання 2: Виконання математичних операцій
sum_result = a + b
sub_result = c - d
mul_result = a * c
...
# Завдання 3: Кількість елементів у списку та виведення парних
...
# Завдання 4: Обмін другого і п’ятого елементів місцями
if len(results) >= 5:
...
# Завдання 5: Виведення автора та висновків
